...
module Checklists
  class ChecklistsController < ApplicationController
    ...
    def index
      ...
      render Checklists::Index.new(
        trip: @trip, checklists: @checklists
      )
    end

    def show
      render Checklists::Show.new(
    ...
    def new
      ...
      render Checklists::New.new(
        trip: @trip, checklist: @checklist
      )
    end

    def edit
      render Checklists::Edit.new(
        trip: @trip, checklist: @checklist
      )
    end
    ...
    def set_checklist
      @checklist = @trip.checklists.find(params.expect(:id))
    end
