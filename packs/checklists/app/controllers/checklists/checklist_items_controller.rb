  ...
  class ChecklistItemsController < ApplicationController
    ...
    def create
      section = @checklist.checklist_sections.find(
        params.dig(:checklist_item, :checklist_section_id)
      )
    ...
    def toggle
      Checklists::Items::Toggle.new.call(
    ...
    def set_checklist
      @checklist = @trip.checklists.find(params.expect(:checklist_id))
    end
    ...
    def authorize_checklist_item!
      item = @checklist_item || @checklist.checklist_sections
                                          ...
                                          &.checklist_items
                                          &.new
      authorize!(item || Checklists::Item.new(
