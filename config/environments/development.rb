...
Rails.application.configure do
  ...
  # Store uploaded files in SeaweedFS S3 (see config/storage.yml).
  # Start the store with: bin/cli storage start
  ...
  config.action_mailer.default_url_options = { host: "catalyst.workeverywhere.docker", protocol: "https" }
  config.action_mailer.asset_host = "https://catalyst.workeverywhere.docker"
